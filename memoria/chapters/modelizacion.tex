...
Definimos el riesgo empírico o error empírico de un clasificador $h$ como:
...
Este clasificador es un ERM, pero $\prob[h_S(x)] = 1/2$ y tiene el mismo nivel de acierto que el 
clasificador idénticamente $1$. A este fenómeno lo denominamos \textit{overfitting}.
\end{example}
